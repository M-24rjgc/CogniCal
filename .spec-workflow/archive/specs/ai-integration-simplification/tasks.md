# Tasks: AI Integration Simplification

- [x] 1. Prune legacy CoT provider stack in ai_service.rs
...
- [x] 2. Simplify DeepSeekProvider invoke logic and normalize errors
...
- [x] 3. Update Tauri command and TS bridge for normalized errors
...
- [x] 4. Refactor useTaskForm AI state management
...
- [x] 5. Redesign Task AI panel UI for single-provider flow
...
- [x] 6. Adjust Settings page AI status section
...
- [x] 7. Extend Rust unit and integration tests for AI service
...
- [x] 8. Update frontend unit tests for hooks and components
  - File(s): src/**tests**/TaskPlanningPanel.test.tsx (if referencing AI), create new tests under src/**tests**/useTaskForm.test.tsx, src/**tests**/TaskAiParsePanel.test.tsx
...
- [x] 9. Refresh Playwright E2E scenario for AI parse flow
